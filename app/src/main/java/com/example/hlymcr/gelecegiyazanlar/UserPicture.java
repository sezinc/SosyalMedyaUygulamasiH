...
/**
 Belleği patlatmadan yeniden boyutlandırılmış görüntüler oluşturur. Android'de açıklanan yöntemi kullanır
  * Bitmap tahsisi ile ilgili dokümantasyon, görüntüyü daha küçük bir boyuta alt örneklemek için,
  * Beklenen bazı boyutlara yakın. Androidi standart kütüphanesi bunu yapamazsa bu gereklidir
  * Son boyuta kıyasla bellek kullanarak bir görüntü dosyasından küçültülmüş bir boyut görüntüsü oluşturun (ve
  * İşlem için tam boyutlu çok megapiksel resim yüklemek,
...
public class UserPicture {
    ...
    /* Galeri uygulamaları ve uzak ("picasa") görüntüler için destek */
    ...
    /* Dosya yöneticileri ve dropbox desteği */
    ...
    private boolean getStoredDimensions() throws IOException {
        ...
        /* Giriş akışı, kapalı yerine sıfırlanabilir ve mümkünse yeniden açılabilir
           Girdi akışını arabelleğe alınmış bir akış üzerine güvenilir şekilde sarmak için kullanmanız gerekir, ancak bunun nedeni
           DecodeStream (), yapılacak bir sıfırlama için 1024 baytın üst okuma sınırını yerleştirir (çağırır
           Akışta işaret (1024)). */
        input.close();
